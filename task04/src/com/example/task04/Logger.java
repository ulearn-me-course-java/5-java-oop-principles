...
public class Logger {
    ...
    //LinkedList не реализован в виде списка с двойной связью.
    //Его производительность на добавление и удаление лучше, чем ArrayList, но хуже на методы get и set.
    ...
    void log(SeverityLevels lvl, String mess, Object... objects) {
        ...
        if (this.lvl == null || this.lvl.compareTo(lvl) <= 0) {
            for (MessageHandler handler : handlers)
                handler.printMessage("[" + lvl + "] " + formatDate.format(new Date()) + " "
