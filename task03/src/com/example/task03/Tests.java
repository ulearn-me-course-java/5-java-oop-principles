...
public class Tests {
    ...
    public void testSeconds3() {
        testTimeUnit(new Seconds(30), 30000, 30, 1, 0);
    }
    ...
    public void testMinutes2() {
        testTimeUnit(new Minutes(70), 4200000, 4200, 70, 1);
    }
    ...
    @Test
    public void testUtils5() {
        Minutes minutes = TimeUnitUtils.toMinutes(new Seconds(59));
        testTimeUnit(minutes, 60000, 60, 1, 0);
    }

    @Test
    public void testUtils6() {
        Hours hours = TimeUnitUtils.toHours(new Minutes(59));
        testTimeUnit(hours, 3600000, 3600, 60, 1);
    }
}
